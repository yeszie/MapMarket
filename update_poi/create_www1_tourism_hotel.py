...
data_file = 'tourism_hotel.geojson'                                
output_folder = 'static/tourism_hotel'
...
<head>
    ...
    <title>Indeks Stron - tourism: hotel</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Indeks Stron - tourism: hotel</h1>
    </header>
...
for feature in geojson_data['features']:
    ...
    name = properties.get('name', '_tourism_hotel_')
