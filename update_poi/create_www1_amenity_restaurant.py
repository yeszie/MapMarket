...
data_file = 'amenity_restaurant.geojson'                                
output_folder = 'static/amenity_restaurant'
...
<head>
    ...
    <title>Indeks Stron - amenity: restaurant</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Indeks Stron - amenity: restaurant</h1>
    </header>
...
for feature in geojson_data['features']:
    ...
    name = properties.get('name', '_amenity_restaurant_')
    ...
    if not sanitized_name:  # Jeśli po sanitacji nazwa jest pusta, ustaw domyślną nazwę
        base_filename = "_amenity_restaurant_"
    ...
    data = {
        ...
        'street_view_url': f'https://maps.googleapis.com/maps/api/streetview?size=800x600&location={feature["geometry"]["coordinates"][1]},{feature["geometry"]["coordinates"][0]}&key=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
