...
data_file = 'railway_station.geojson'                                
output_folder = 'static/railway_station'
...
<head>
    ...
    <title>Indeks Stron - Railway station</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Indeks Stron - Railway station</h1>
    </header>
...
for feature in geojson_data['features']:
    ...
    name = properties.get('name', '_railway_station_')
    ...
    if not sanitized_name:  # Jeśli po sanitacji nazwa jest pusta, ustaw domyślną nazwę
        base_filename = "_railway_station_"
    ...
    data = {
        ...
        'street_view_url': f'https://maps.googleapis.com/maps/api/streetview?size=800x600&location={feature["geometry"]["coordinates"][1]},{feature["geometry"]["coordinates"][0]}&key=XXXXXXXXXXXXXXXXXXXXXXX',
