...
data_file = 'healthcare.geojson'                                
output_folder = 'static/healthcare'
...
<head>
    ...
    <title>Indeks Stron - healthcare</title>
    <style>
        body {
...
for feature in geojson_data['features']:
    ...
    name = properties.get('name', '_healthcare_')
    ...
    data = {
        ...
        'street_view_url': f'https://maps.googleapis.com/maps/api/streetview?size=800x600&location={feature["geometry"]["coordinates"][1]},{feature["geometry"]["coordinates"][0]}&key=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
